        ...
        <div className="about">
            <div className="formContainer">
                ...
                <form className="form formLogin">
                    ...
                    <div className="formInputContainer">
                        <div className="formInputWrapper">
                            <select onChange={props.handleChange} name="secQuestion2">
                                <option value="What is your Favorite Junk Food?" >What is your Favorite Junk Food?</option>
                                <option value="Apple or Samsung?">Apple or Samsung?</option>
                                <option value="StarWars or StarTrek?">StarWars or StarTrek?</option>
                    ...
                    <div className="formInputContainer">
                        <button className="formButton" onClick={(event) => props.handleClick(event)}>Submit</button>
